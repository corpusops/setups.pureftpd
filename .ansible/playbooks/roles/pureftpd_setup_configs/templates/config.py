...
import json
from pureftpd.utils.translation import gettext_lazy as _
{% for setting, value in data.get('pureftpd_settings', {}).items() -%}
{{render_setting(setting, value)}}
{%- endfor %}
{% for setting, value in data.get('extra_pureftpd_settings', {}).items() -%}
{{render_setting(setting, value)}}
{%- endfor %}
